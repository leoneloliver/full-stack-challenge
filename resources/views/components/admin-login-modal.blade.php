                ...
                <div class="mt-3 text-center sm:mt-5">
                    ...
                    <div class="mt-4">
                        <form @submit.prevent="login()">
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        id="username"
                                        x-model="username"
                                        class="pl-10 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-300 rounded-md py-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        placeholder="admin"
                            ...
                            <div class="text-left">
                                <p x-show="error" x-text="error" class="text-red-600 dark:text-red-400 mb-4"></p>
                            </div>
                            <div class="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                                ...
                                <button
                                    type="button"
                                    @click="closeModal()"
                                    class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:col-start-1 sm:text-sm dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600">
                                    Cancel
                                </button>
                            </div>
                        </form>
